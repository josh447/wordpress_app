...
site1 = 'wordpress_site'

node.default['apache']['sites'][site1]['port']         = 80
node.default['apache']['sites'][site1]['cookbook']     = 'wordpress_app'
node.default['apache']['sites'][site1]['template']     = "apache2/sites/wordpress_app.erb"
...
node.default['apache']['sites'][site1]['repository'] = 'https://github.com/josh447/wordpress.git'
